...
namespace StudentAttendanceManagementSystem.Migrations
{
    ...
    [Migration("20240827062242_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentAttendanceManagementSystem.Models.User", b =>
                {
                    ...
                    b.Property<string>("StudentRemarkId")
                        .HasColumnType("TEXT");

                    b.HasIndex("StudentRemarkId");
            ...
            modelBuilder.Entity("StudentAttendanceManagementSystem.Models.User", b =>
                {
                    b.HasOne("StudentAttendanceManagementSystem.Models.Remark", "StudentRemark")
                        .WithMany()
                        .HasForeignKey("StudentRemarkId");

                    b.Navigation("StudentRemark");
                });
